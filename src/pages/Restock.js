...
export default function Restock({ stockStatus, setStockStatus }) {
...
return (
  <div className="restock-page" style={{ padding: "20px", maxWidth: "800px", margin: "0 auto" }}>
    <div className="logo-title">
      <h1 className="brand-title" style={{ color: "#e91e8c" }}>Inventory Tracker</h1>
      <p className="slogan">Monitor your inventory levels and view historical data ♡</p>
    </div>
    ...
    <h2 style={{ color: "#e91e8c", textAlign: "center", fontFamily: "inherit" }}>Inventory Status</h2>
    ...
    <h2 style={{ color: "#e91e8c", textAlign: "center", fontFamily: "inherit" }}>Restock History</h2>
